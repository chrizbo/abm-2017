...
to setup
  ...
  create-turtles 100 [
    ...
    ;; set the turtles personalities based on a chooser
    ...
    ;; choose friend and enemy of the group
...
to act-cowardly
  ;; move away from enemy on the other side of the friend
...
to act-bravely
  ;; move towards the midpoint between your friend and your enemy
...
This is a model of heros and cowards. 
